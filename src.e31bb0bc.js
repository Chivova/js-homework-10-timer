...
var CountdownTimer = /*#__PURE__*/function () {
  ...
  _createClass(CountdownTimer, [{
    ...
    value: function timerStart() {
      ...
      var finaleDate = this.targetDate;
      setInterval(function () {
        var currentDate = new Date();
        var amountTime = finaleDate - currentDate;

        var time = _this.getTimerComponents(amountTime);
    ...
    key: "getTimerComponents",
    value: function getTimerComponents(time) {
...
function dateOutputFace(_ref2) {
  ...
  refs.minutes.textContent = "".concat(mins);
  refs.seconds.textContent = "".concat(secs);
}
